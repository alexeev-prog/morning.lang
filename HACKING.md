...
hidden if the `morninglang_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `morninglang_DEVELOPER_MODE` to the configure
...
Runs the executable target `morninglang_exe`.
